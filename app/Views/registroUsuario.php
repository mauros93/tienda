...
<body>
    ...
    <div class="container-fluid">
        <nav class="navbar navbar-expand-lg d-flex justify-content-between" style="background-color: black;" >
    ...
    <div class="container-fluid">        
        <div class="row justify-content-center">
            <form class="col-8" action="registrarUsuario" method="post">
                <h3 class="my-4 pb-3">Registrate</h3>                 
                <div class="form-group">
                    <label for="inputAddress2">Nombres</label>
                    <input type="text" name="nombres" class="form-control" id="inputAddress2">
                </div>
                <div class="form-row">
                    ...
                    <input type="number" name="telefono" class="form-control" id="validationDefault01" required>
                    </div>                    
                </div>
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="direccion" class="form-control" id="inputAddress2">
                </div>                
                                ...
                                <div class="modal-body">
                                    <form action=<?= base_url("public/UserController/actualizarusuario/".$usuario['id_usuario'])?> method="post">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                            <label for="validationDefault02">Ciudad</label>
                                            <input type="text" name="ciudad" value="<?= $usuario['pais'] ?>" class="form-control" id="validationDefault02" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputAddress2">Direccion</label>
